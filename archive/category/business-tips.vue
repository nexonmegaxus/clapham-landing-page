    ...
    <main>
        ...
        <section class="section pb-[32px]">
            <div class="div flex-col gap-[16px]">
                ...
                <p class="font-20 font-bold text-c-blue">Business Tips</p>
            </div>
        </section>
...
const { data: articles } = await useFetch(
    'https://cms-clapham.workfrom.id/wp-json/wp/v2/posts?_fields=id,slug,yoast_head_json.og_image,yoast_head_json.description,yoast_head_json.author,title,description,date,categories&per_page=10&categories=30'
);
// seo meta
useSeoMeta({
    title: 'Business Tips',
